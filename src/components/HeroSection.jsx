      ...
      <div className="flex flex-col md:flex-row justify-end mx-auto items-center gap-6  ">
        <div className="w-full">
          <div className="px-4">
            ...
            <h1 className=" font-semibold text-center md:text-left text-[#09060c] dark:text-white/90 text-2xl md:text-3xl lg:text-4xl my-2 hero-title">
              with QTEC TODO
            </h1>
          </div>
          <p className="text-lg text-gray-500 dark:text-gray-400 text-wrap px-4 text-justify mt-4">
